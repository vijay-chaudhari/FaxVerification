    ...
    function initModal(modalManager, args) {
        ...
        $(document).ready(function () {
            $('#saveConfig').click(function () {
                ...
                var VendorNo = document.querySelector('#Attribute_1').value;
                var VendorName = document.querySelector('#Attribute_2').value;

                var FilePath = document.querySelector('#Data_FilePath').value;

                document.querySelector('#Data_vendorNo').value = VendorNo;
                document.querySelector('#Data_TemplateName').value = VendorName ;
                ...
                for (var i = 1; i <= DocumnetNumber; i++) {
                    ...
                    var LabelN = document.getElementById("lbl_" + i).innerHTML;
                ...
                var cordinates = document.querySelector('#Data_TableCordinates_Rectangle').value.split(',');
                var page = document.querySelector('#Data_TableCordinates_PageNumber').value;
                ...
                var tableCordinates = {
                    //"TemplateId":"",
                    "FieldName": "TableCordinates",
                    "Text": "Table",
                    "Rectangle": cords,
                    "PageNumber": parseInt(page)
                }
                AdditionalFields.push(tableCordinates);
                ...
                let ObjDTO = {
                    ...
                    "vendorNo": VendorNo,
                    "templateName": VendorName,
                    "ocrConfig": JSON.stringify(output),
                    "filePath": FilePath,
        ...
        let fileName = "./Pdf/PendingPDF/" + document.querySelector("#Data_FilePath").value;
        ...
        WebViewer({
            ...
            const setText = (text, rect, pageIndex) => {
                ...
                if (activeElement.id === 'table_cordinates') {
